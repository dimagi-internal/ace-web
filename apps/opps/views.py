...
from apps.opps.access import (
    overlay_workspace_display_name as _overlay_workspace_display_name,
)
from apps.opps.access import (
    require_drive as _require_drive,
)
from apps.opps.access import (
    resolve_ace_root_folder_id as _resolve_ace_root_folder_id,
)
from apps.opps.access import (
    resolve_workspace as _resolve_workspace,
)
from apps.opps.access import (
    snapshot_etag as _snapshot_etag,
)
