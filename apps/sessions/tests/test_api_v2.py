"""Contract tests for apps.sessions.api_v2.

Pattern mirrors apps/opps/tests/test_api_v2.py:
...
def test_create_session_201(member_client, monkeypatch):
    client, workspace, _ = member_client
    monkeypatch.setattr(
        "apps.sessions.api_v2.create_session_in_workspace",
...
def test_patch_session_happy(member_client, monkeypatch):
    client, workspace, _ = member_client
    monkeypatch.setattr(
        "apps.sessions.api_v2.patch_session_in_workspace",
