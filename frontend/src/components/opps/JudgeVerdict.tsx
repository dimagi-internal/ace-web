  ...
  return (
    <div className="rounded bg-card p-2.5">
      <div className="flex items-center justify-between">
        <div className="text-[9px] uppercase tracking-wider text-muted-foreground">Judge</div>
      ...
      {Object.keys(judge.criteria).length > 0 && (
        <div className="mt-1.5 grid grid-cols-2 gap-x-2 gap-y-0.5 text-[9px] text-muted-foreground">
