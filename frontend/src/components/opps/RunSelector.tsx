...
interface RunSelectorProps {
   ...
   * Receives the deleted run id so the parent can decide whether to
   * navigate away (the deleted run was the one in the URL) or just
   * refresh the runs strip (some other run was trashed). */
