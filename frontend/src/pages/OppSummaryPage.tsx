...
export default function OppSummaryPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-3xl space-y-16 px-6 py-14">
        {apps.length > 0 && (
              ...
              <SummaryRow
                ...
                name={
                  <>
                    ...
                    {(connect.opportunity.start_date || connect.opportunity.end_date) && (
        ...
        <footer className="flex flex-wrap items-center justify-between gap-3 border-t border-border pt-8 text-sm text-muted-foreground">
          <span>
            Generated by ACE · run <span className="font-mono">{opp.run_id}</span>
          </span>
          {workbench_url && (
            <a
              href={workbench_url}
